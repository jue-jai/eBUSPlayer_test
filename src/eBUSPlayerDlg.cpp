...
BEGIN_MESSAGE_MAP(eBUSPlayerDlg, CDialog)
    ...
    ON_CBN_DROPDOWN( IDC_MODE, &eBUSPlayerDlg::OnCbnDropdownMode )
    ...
    ON_MESSAGE(WM_REOPENSTREAMIFNEEDED, &eBUSPlayerDlg::OnReopenStreamIfNeeded)
    ON_MESSAGE(WM_DISCONNECT, &eBUSPlayerDlg::OnDisconnect)
...
// =============================================================================
void eBUSPlayerDlg::PreDisconnectUI()
{
