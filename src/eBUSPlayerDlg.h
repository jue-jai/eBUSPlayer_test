...
#define PLAYER_VERSION_STRING	  "0.1.0\0"
...
public:
	...
	virtual CString GetAppName() const { return _T("eBUS Player for lossless "); }
...
protected:
	...
	afx_msg void OnCbnDropdownMode();
	...
	LRESULT OnReopenStreamIfNeeded(WPARAM wParam, LPARAM lParam);
